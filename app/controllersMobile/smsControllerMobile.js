...
class SmsControllerMobile {
	...
	sendSms = async (req, res) => {
		try {
			...
			// });
			return await res.createErrorLogAndSend({ message: ServerLoginMessages.FAILED_TO_SEND_SMS, status: 401 });
		} catch (err) {
			// res.status(500).send({
...
export default SmsControllerMobile;
